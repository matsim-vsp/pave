...
public class RunChessboardScenarioWithNormalFreight {
    ...
    ;
    private static final String OUTPUT_DIR = "output/combinedPFAVAndCarrierTest/" + new SimpleDateFormat("YYYY-MM-dd_HH.mm").format(new Date()) + "/";
...
//        CarrierModule carrierController = new CarrierModule(carriers, null, null);
    ...
    private static void configureControlerForPFAV(String carriersFile, String vehTypesFile, TaxiConfigGroup taxiCfg, String mode, Scenario scenario, Controler controler) {
