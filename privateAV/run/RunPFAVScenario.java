...
public class RunPFAVScenario {
    ...
    private static final String CONFIG_FILE_ASSIGNMENT = "scenarios/mielec/mielec_taxi_config_assigment.xml";

    private static final String SMALL_CARRIERS_FILE = "scenarios/mielec/freight/neu/carrierPlans_routed_finite2.xml";
