...
//            double latestBlockingSchedulingTime = 22 * 3600.;
            ...
            double latestBlockingSchedulingTime = config.qsim().getEndTime().seconds() - (drtBlockingRequest.getBlockingDuration() + schedulingBuffer);
...
//                for(int i = 0 ; i < nrOfAvailableVehicles; i++){
    ...
    private void rescheduleBlockingStartAndEnd(DrtBlockingRequest request) {
            ...
            double adaptedStartTime = timer.getTimeOfDay();
