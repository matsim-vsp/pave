...
class DefaultBlockingRequestEngine implements BlockingRequestEngine {

    private Scenario scenario;
    private BlockingOptimizer optimizer;
    private BlockingRequestCreator blockingRequestCreator;

    DefaultBlockingRequestEngine(Scenario scenario, BlockingOptimizer optimizer, BlockingRequestCreator blockingRequestCreator) {
