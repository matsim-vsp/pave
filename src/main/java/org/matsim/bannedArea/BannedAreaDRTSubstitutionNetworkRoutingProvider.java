...
class BannedAreaDRTSubstitutionNetworkRoutingProvider implements Provider<RoutingModule> {
	private static final Logger log = Logger.getLogger( BannedAreaDRTSubstitutionNetworkRoutingProvider.class ) ;
	 ...
	 * @param bannedMode
	 */
	BannedAreaDRTSubstitutionNetworkRoutingProvider(String bannedMode,
													String drtMode,
													com.google.inject.Provider<RoutingModule> drtRoutingModuleProvider) {
		this( bannedMode, bannedMode, drtMode, drtRoutingModuleProvider) ;
	}
