...
public class InputExpectedTravelTime {
	...
	public static final double[] newMinTT = new double[] { 0.0, 1318, 419, 643, 534, 426, 629, 587, 490, 758, 719, 412,
			534, 528, 557, 688, 348, 714, 483, 714 };

	public static final double[] newAvgTT = new double[] { 0.0, 1422.791667, 481.5, 690.5416667, 580.625, 455.8333333,
			669.9166667, 650.7916667, 550, 823.875, 798.125, 444.2916667, 564.0833333, 580.0833333, 642.2916667,
			778.375, 406.4583333, 804.9166667, 606.4166667, 838.875 };

	public static final double[] newMaxTT = new double[] { 0.0, 1640, 589, 777, 637, 483, 714, 760, 650, 912, 856, 474,
			607, 652, 761, 838, 507, 937, 727, 947 };
