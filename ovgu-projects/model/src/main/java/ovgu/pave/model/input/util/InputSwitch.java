...
public class InputSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case InputPackage.ORIGIN_REQUEST_ACTIVITY: {
				OriginRequestActivity originRequestActivity = (OriginRequestActivity)theEObject;
				T result = caseOriginRequestActivity(originRequestActivity);
				if (result == null) result = caseRequestActivity(originRequestActivity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case InputPackage.DESTINATION_REQUEST_ACTIVITY: {
				DestinationRequestActivity destinationRequestActivity = (DestinationRequestActivity)theEObject;
				T result = caseDestinationRequestActivity(destinationRequestActivity);
				if (result == null) result = caseRequestActivity(destinationRequestActivity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Origin Request Activity</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Origin Request Activity</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOriginRequestActivity(OriginRequestActivity object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Destination Request Activity</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Destination Request Activity</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDestinationRequestActivity(DestinationRequestActivity object) {
		return null;
	}
